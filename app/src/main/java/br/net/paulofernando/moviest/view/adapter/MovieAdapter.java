...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder>
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ActivityOptions transitionActivityOptions = ActivityOptions.
                            makeSceneTransitionAnimation((Activity) MovieAdapter.this.context, sharedView, transitionName);

                    MovieAdapter.this.context.startActivity(intent, transitionActivityOptions.toBundle());
                }
            });
        }
        ...
        public void setMovie(Movie movie) {
            ...
            try {
                Picasso.with(context).load("http://image.tmdb.org/t/p/" + TMDB.SIZE_DEFAULT + movie.posterPath).
    ...
    public MovieAdapter(List<Movie> _listOfMovies, Context _context) {
