...
import static br.net.paulofernando.moviest.data.remote.TMDB.API_KEY;
import static br.net.paulofernando.moviest.data.remote.TMDB.Services.*;
import static br.net.paulofernando.moviest.data.CacheManager.*;
